...
public class DaoEpreuve {
    ...
    public static ArrayList<Epreuve> getLesEpreuves(Connection cnx){
        ...
        try{
            requeteSql = cnx.prepareStatement("select e.id as e_id, e.libelle as e_libelle" +
            ...
            while (resultatRequete.next()){
                ...
                a.setId(resultatRequete.getInt("e_id"));
                a.setLibelle(resultatRequete.getString("e_libelle"));
